...
outcome_labels = ['Owner', 'Rescue Group', 'Adopted', 'Foster', 'Euthanized', 'Unkown']
olderThan1 = np.array([0.0,0,0,0,0,0])
youngerThan1 = np.array([0.0,0,0,0,0,0])
other = np.array([0.0,0,0,0,0,0])
olderThan7 = np.array([0.0,0,0,0,0,0])
...
for dog in rows:
    ...
    try:
        ...
        if age == 'Youth - Younger than 1 year' :            
            # one of outcome_types
            youngerThan1[i] = youngerThan1[i] + 1
        elif age == 'Older than 1 year' :
            # one of outcome_types
            olderThan1[i] = olderThan1[i] + 1
        elif age == 'Older than 7 years' :
            # one of outcome_types
            olderThan7[i] = olderThan7[i] + 1
        else :
            # everything else
            other[i] = other[i] + 1
    except ValueError:
        ...
        if age == 'Youth - Younger than 1 year' :            
            # one of outcome_types
            youngerThan1[5] = youngerThan1[i] + 1
        elif age == 'Older than 1 year' :
            # one of outcome_types
            olderThan1[5] = olderThan1[5] + 1
        elif age == 'Older than 7 years' :
            # one of outcome_types
            olderThan7[5] = olderThan7[5] + 1
        else :
            # everything else
            other[5] = other[5] + 1
...
print "olderThan1", olderThan1
print "youngerThan1",  youngerThan1
print "other",  other
print "olderThan7", olderThan7 
...
bar_width = 0.15
opacity = 0.4
rects1 = plt.bar(index, youngerThan1, bar_width, alpha=opacity, color='r', label='Younger than 1')
rects2 = plt.bar(index+bar_width, olderThan1, bar_width, alpha=opacity, color='b', label='Older than 1')
rects3 = plt.bar(index+bar_width+bar_width, olderThan7, bar_width, alpha=opacity, color='g', label='Older than 7 years')
rects4 = plt.bar(index+bar_width+bar_width+bar_width, other, bar_width, alpha=opacity, color='y', label='Other')
plt.ylabel('Number')
plt.title('Pratyushs Number of animals by age and outcome type')
...
Observed = np.array([youngerThan1, olderThan1])
X_2, p, dof, expected= scipy.stats.chi2_contingency(Observed)
print "youngerThan1 and olderThan1"
print "X_2", X_2, ", p", p
...
if (p < alpha):
    print "The difference is significant. H0 (youngerThan1 and olderThan1 have the same outcomes) is rejected." 
else:
    print "The difference is not significant. H1 (youngerThan1 and olderThan1 have different outcomes) is rejected."

Observed = np.array([olderThan1, olderThan7])
X_2, p, dof, expected= scipy.stats.chi2_contingency(Observed)
print "olderThan1 and olderThan7"
print "X_2", X_2, ", p", p
...
# Step 5: State conclusion:
if (p < alpha):
    print "The difference is significant. H0 (olderThan1 and olderThan7 have the same outcomes) is rejected." 
else:
    print "The difference is not significant. H1 (olderThan1 and olderThan7 have different outcomes) is rejected."

Observed = np.array([youngerThan1, olderThan7])
X_2, p, dof, expected= scipy.stats.chi2_contingency(Observed)
print "youngerThan1 and olderThan7"
print "X_2", X_2, ", p", p
...
# Step 5: State conclusion:
if (p < alpha):
    print "The difference is significant. H0 (youngerThan1 and olderThan7 have the same outcomes) is rejected." 
else:
    print "The difference is not significant. H1 (youngerThan1 and olderThan7 have different outcomes) is rejected."        
...
for train, test in skf:
    ...
    tree.export_graphviz( dt, out_file = 'tree23.dot', feature_names=features)
