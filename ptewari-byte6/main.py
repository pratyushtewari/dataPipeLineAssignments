...
class MainHandler(BaseHandler):
    def get(self):
        ...
        query_string = "SELECT mother_age, mother_race, alcohol_use, avg(weight_pounds), count(*) FROM [{0}] where state='PA' and alcohol_use is not NULL GROUP by mother_age, mother_race, alcohol_use order by mother_age desc;".format(_DATABASE_NAME)
